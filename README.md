...
static server. The demo uses the single packed `wheel-drivetrain-animated.svg`
file so the full animation can be dropped into another app as one SVG asset.
